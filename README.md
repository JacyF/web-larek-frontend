...
**Методы:**  
- `render` - отображает сообщение, указывающее на списанное количество, и возвращает некоторое значение (success), которое может быть использовано для указания результата операции.
